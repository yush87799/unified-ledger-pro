                  ...
                  <TableBody>
                    {loadingHistory ? (
                      ...
                      <TableRow key={inv.id} className="border-none hover:bg-primary/[0.03] transition-colors">
                        ...
                        <TableCell><Badge variant="outline" className="text-[10px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded-md">{inv.paymentMode}</Badge></TableCell>
            ...
            {previewInvoice && (
              <div className="space-y-10">
                ...
                <div className="flex justify-between text-sm border-b-2 border-slate-100 pb-8">
                  <div className="space-y-2"><p className="font-black text-primary uppercase text-[10px] tracking-[0.2em]">Billed To:</p><p className="font-black text-2xl tracking-tighter">{previewInvoice.customer?.name}</p><p className="opacity-70 font-bold text-base">{previewInvoice.customer?.phone}</p></div>
